    ...
    constructor() {
        ...
        this.dataTypes = {
            ...
            object: class {
                ...
                read(params, nested = {}) {
                    console.warn("Warning: Trying to read an object. Current version doesn´t support this feature.")
                    return "(object)"
                }
                set(params, memory = {}) {
                    if (typeof params != "object")
                        throw "Exception: Objects must be initialized directly. Copying is no supported in the current version."
                    for (let i in params) {
                        let left = i.split(" ")
            ...
            array: class {
                ...
                read(params, nested = {}) {
                    console.warn("Warning: Trying to read an array. Current version doesn´t support this feature.")
                    return "(array)"
                }
                set(params, memory = {}) {
                    if (typeof params != "object")
                        throw "Exception: Array must be initialized as an object. Copying is no supported in the current version."
                    let count = 0
                    for (let i in params) {
                        let datatype = i
